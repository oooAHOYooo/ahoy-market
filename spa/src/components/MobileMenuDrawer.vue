  ...
  <Teleport to="body">
    ...
    >
        ...
        <nav class="offcanvas-nav">
          ...
          <router-link to="/poems" @click="close"><i class="fas fa-feather"></i><span>Poems</span></router-link>
          <router-link to="/studio" @click="close"><i class="fas fa-camera"></i><span>Studio</span></router-link>
          <router-link to="/live-tv" @click="close"><i class="fas fa-tv"></i><span>AHOY TV</span></router-link>
